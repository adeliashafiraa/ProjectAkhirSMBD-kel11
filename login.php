...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $conn->prepare("CALL LoginProcedure(?, ?, @login_status)");
    ...
    // Mengambil nilai status login
    $result = $conn->query("SELECT @login_status AS login_status");
    ...
    if ($login_status == 'Success') {
        ...
        // Login gagal
        $error = "Username atau password salah, atau Anda tidak memiliki akses ke WorkPlus.";
    }
}
?>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Selamat Datang di Website WorkPlus!</h1>
                                    </div>
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="register.php">Buat Akun Admin!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
