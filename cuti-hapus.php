            ...
            <div class="card-body p-0">
                ...
                <div class="p-5">
                    <div class="text-center">
                        <h1 class="h4 text-gray-900 mb-4">Hapus cuti karyawan</h1>
                    </div>
                    <form class="user" action="cuti-delete.php" method="POST" enctype="multipart/form-data">
                    <?php
                            include "conn.php";
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                                <input type="text" class="form-control form-control-user" id="kode" name="kode" placeholder="KODE CUTI" value="<?php echo $row['kode']; ?>">
                            </div>
                            <div class="col-sm-6">
