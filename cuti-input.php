            ...
            <div class="card-body p-0">
                ...
                <div class="p-5">
                    <div class="text-center">
                        <h1 class="h4 text-gray-900 mb-4">Input cuti karyawan</h1>
                    </div>
                    <form class="user" action="insert_cuti.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                                <input type="date" class="form-control form-control-user" id="tanggal_awal" name="tanggal_awal" placeholder="Tanggal awal cuti" required>
                            </div>
                            <div class="col-sm-6">
                            <input type="date" class="form-control form-control-user" id="tanggal_akhir" name="tanggal_akhir" placeholder="Tanggal akhir cuti" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                                <input type="text" class="form-control form-control-user" id="jumlah" name="jumlah" placeholder="Jumlah cuti diajukan" required>
                            </div>
                            <div class="col-sm-6">
                                <input type="text" class="form-control form-control-user" id="jenis_cuti" name="jenis_cuti" placeholder="Jenis Cuti" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                                <input type="text" class="form-control form-control-user" id="ket" name="ket" placeholder="Keterangan" required>
                            </div>
                            <div class="col-sm-6 mb-3 mb-sm-0">
                                <input type="date" class="form-control form-control-user" id="tanggal_masuk" name="tanggal_masuk" placeholder="Tanggal masuk">
                            </div>
                        </div>
                        <div>
                        <div class="col-sm-6">
                                ...
                                <label for="tetap">Approved</label><br>
                                <input type="radio" id="pending" name="status" value="Pending">
                                <label for="pkwt">Pending</label><br>
                                <input type="radio" id="rejected" name="status" value="Rejected">
                                <label for="pkwtt">Rejected</label><br><br>
                            </div>
                        </div>
